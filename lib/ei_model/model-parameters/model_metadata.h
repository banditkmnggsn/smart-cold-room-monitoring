...
#define EI_CLASSIFIER_PROJECT_ID                 882654
#define EI_CLASSIFIER_PROJECT_OWNER              "banditkmnggsn"
#define EI_CLASSIFIER_PROJECT_NAME               "Cold-Room-Monitoring-Stephen-Chuang"
...
#define EI_CLASSIFIER_INTERVAL_MS                5000
#define EI_CLASSIFIER_NN_OUTPUT_COUNT            3
#define EI_CLASSIFIER_LABEL_COUNT                3
#define EI_CLASSIFIER_SINGLE_FEATURE_INPUT       1
#define EI_CLASSIFIER_FREQUENCY                  0.2
#define EI_CLASSIFIER_SENSOR                     EI_CLASSIFIER_SENSOR_FUSION
#define EI_CLASSIFIER_FUSION_AXES_STRING         "temperature1_c + humidity1_percent + temperature2_c + humidity2_percent + dT1 + dT2 + avgT1_5 + avgT2_5 + stdT1_5 + stdT2_5 + stuck_count1 + stuck_count2 + diffT + abs_dT1 + abs_dT2"
